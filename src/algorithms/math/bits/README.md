...
#### Insert a number M into a number N

You are given two 32-bit numbers, N and M, and two bit positions, i and j. 
This methods inserts M into N such that M starts at bit j and ends at bit i. 
We assume that bits j through i have enough space to fit all of M. 
...
OUTPUT:
    N = 100 0100 1100
```
> See [insert.js](insert.js) for further details.


#### Swap odd and even bits in a integer

This method swaps odd and even bits in an integer.
Bit 0 ans bit 1 are swapped. Bit 2 and bit 3 are swapped. And so on...

> See [swapOddEvenBits.js](swapOddEvenBits.js) for further details.
